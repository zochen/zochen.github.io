    ...
    <section id="resume" className="py-10 border-t border-warm-200 dark:border-warm-600">
      <div className="flex items-baseline justify-between mb-8">
        ...
        <a
          ...
          className="flex items-center gap-2 text-sm px-3 py-1.5 rounded-none border border-warm-300 dark:border-warm-600 text-warm-600 dark:text-warm-300 hover:text-warm-700 dark:hover:text-warm-100 transition-colors"
        >
          <Download size={16} />
          Download PDF
        </a>
