...
export default function About() {
  ...
  return (
    <section className="py-8 border-t border-warm-200 dark:border-warm-600">
      <h3 className="font-[family-name:var(--font-heading)] text-lg font-semibold text-warm-700 dark:text-warm-200 mt-6 mb-6">
        socials
      </h3>
      ...
      <div className="flex gap-4">
        {socials.map((social) => (
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-warm-200/50 hover:bg-warm-200 dark:bg-warm-600/40 dark:hover:bg-warm-600 text-warm-500 hover:text-warm-700 dark:text-warm-400 dark:hover:text-warm-200 transition-colors"
          >
            <social.icon />
